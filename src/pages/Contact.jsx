...
const Contact = () => {
    return (
        <div className='mt-[120px] pb-[60px] font-Lato'>
            ...
            <p className='text-[18px]  w-[80%]'>Impressed with my work & skills? Want to work with me? You can reach out to me through the social media handles below or you can simply give me a call <FaPhone className='inline' /></p>

            <div className='grid grid-cols-4 gap-10 mt-[40px]'>
                <div className='border-b-[#ea73737d] box flex-row h-[100px] justify-between items-center p-4' >
                ...
                <div className='box border-b-[#5294b37d] flex-row h-[100px] justify-between items-center p-4' >
                ...
                <div className='box border-b-[#5294b37d] flex-row h-[100px] justify-evenly items-center p-4' >
